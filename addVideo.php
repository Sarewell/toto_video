...
if (!empty($_POST['submitted'])) {
    ...
    //créé un nv film
    create($title, $description, $year_created, $first_name_actor, $last_name_actor, $nationality_film, $url_img, $category, $statue);
}  
?>
    ...
    <form method="POST" >
        ...
        <div class="form-control  ">
            ...
            <label class="input-group">
                <span></span>
                <input type="text" placeholder="Type here" class="input input-bordered " name="title" id ="title" value="<?php showInputValue('title')?>" />
            </label>    
        ...
        <div class="form-control">
            ...
            <label class="input-group">
                <span></span>
                <input type="text" placeholder="Type here" class="input input-bordered " name="description" id ="description" value="<?php showInputValue('description')?>" />
            </label>
        ...
        <div class="form-control">
            ...
            <label class="input-group">
                <span></span>
                <input type="number" placeholder="year_created" class="input input-bordered " name="year_created" value="<?php showInputValue('year_created')?>" />
            </label> 
        ...
        <div class="form-control  ">
            ...
            <label class="input-group">
                <span></span>
                <input type="text" placeholder="" class="input input-bordered " name="first_name_actor" id ="first_name_actor" value="<?php showInputValue('first_name_actor')?>"/>
            </label>
        ...
        <div class="form-control  ">
            ...
            <label class="input-group">
                <span></span>
                <input type="text" placeholder="" class="input input-bordered " name="last_name_actor" id ="last_name_actor" value="<?php showInputValue('last_name_actor')?>"/>
            </label>
        ...
        <div class="form-control  ">
            ...
            <label class="input-group">
                <span></span>
                <input type="text" placeholder="" class="input input-bordered " name="nationality_film" id ="nationality_film" value="<?php showInputValue('nationality_film')?>"/>
            </label>
        ...
        <div class="form-control  ">
            ...
            <label class="input-group">
                <span></span>
                <input type="text" placeholder="" class="input input-bordered " name="url_img" id ="url_img" value="<?php showInputValue('url_img')?>"/>
            </label>
        ...
        <div class="form-control">
            ...
            <label class="input-group">
                <span></span>
                <input type="number" placeholder="statue" class="input input-bordered " name="statue" value="<?php showInputValue('statue')?>" />
            </label> 
